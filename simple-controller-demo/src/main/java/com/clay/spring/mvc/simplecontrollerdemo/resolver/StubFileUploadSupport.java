 ...
 * @see StubMultipartResolver
 */
public abstract class StubFileUploadSupport {

	protected final Log logger = LogFactory.getLog(getClass());

	private final DiskFileItemFactory fileItemFactory;

	private final StubFileUpload fileUpload;
	 ...
	 */
	public StubFileUpload getFileUpload() {
	 ...
	 */
	protected abstract StubFileUpload newFileUpload(FileItemFactory fileItemFactory);
	 ...
	 */
	protected StubFileUpload prepareFileUpload(@Nullable String encoding) {
		StubFileUpload fileUpload = getFileUpload();
		StubFileUpload actualFileUpload = fileUpload;
