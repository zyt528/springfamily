package com.clay.spring.data.mybatis.mapper;

import com.clay.spring.data.mybatis.model.Coffee;
import com.clay.spring.data.mybatis.model.CoffeeExample;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Sat Sep 21 19:16:30 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.clay.spring.data.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.clay.spring.data.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.clay.spring.data.mybatis.handler.MoneyTypeHandler},",
