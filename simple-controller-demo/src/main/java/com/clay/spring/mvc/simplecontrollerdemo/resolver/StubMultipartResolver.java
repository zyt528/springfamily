 ...
 * @since 29.09.2003
 * @see #StubMultipartResolver(ServletContext)
 * @see #setResolveLazily
 * @see org.apache.commons.fileupload.servlet.ServletFileUpload
 * @see org.apache.commons.fileupload.disk.DiskFileItemFactory
 */
public class StubMultipartResolver extends StubFileUploadSupport
	 ...
	 */
	public StubMultipartResolver(ServletContext servletContext) {
		this();
	 ...
	 */
	@Override
	protected StubFileUpload newFileUpload(FileItemFactory fileItemFactory) {
		return new StubServletFileUpload(fileItemFactory);
	}
	...
	protected MultipartParsingResult parseRequest(HttpServletRequest request) throws MultipartException {
		...
		StubFileUpload fileUpload = prepareFileUpload(encoding);
		try {
			List<FileItem> fileItems = ((StubServletFileUpload) fileUpload).parseRequest(request);
