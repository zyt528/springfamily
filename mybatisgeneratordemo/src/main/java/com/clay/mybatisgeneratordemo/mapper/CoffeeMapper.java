package com.clay.mybatisgeneratordemo.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Sat Sep 21 17:54:19 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.clay.mybatisgeneratordemo.handler}, ",
    ...
    @ResultMap("com.clay.mybatisgeneratordemo.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.clay.mybatisgeneratordemo.handler},",
